...
- `income:equity:-1000` — register `income` as equity, record −$1000
...
- **Equity** — inflows that increase net worth: `income/salary`, `income/interest`
...
```
Σ Assets  −  Σ Liabilities  =  Σ Income  −  Σ Expenses
```
